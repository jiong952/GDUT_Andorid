...
//                sendOrderedBroadcast(intent,null,receiver, null, 0, null, null); // 发送有序广播
    ...
    class MyBroadcastReceiverOne extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            num=num+1;
            tv_one.setText(num+"");
            Log.i("BroadcastReceiverOne", "广播接收者One,接收到了广播事件");
            delay();
        }
    }
    class MyBroadcastReceiverTwo extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            num=num+1;
            tv_two.setText(num+"");
            Log.i("BroadcastReceiverTwo", "广播接收者Two,接收到了广播事件");
...
//            Log.i("MyBroadcastReceiverTwo", "我是广播接收者Two，广播被我终结了");
            ...
            Log.i("BroadcastReceiverTwo", "广播接收者Two跳转到新页面");
            delay();
        }
    }
    class MyBroadcastReceiverThree extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i("BroadcastReceiverThree", "广播接收者Three,接收到了广播事件");
            delay();
        }
    }
    /**
